...
class PixelFormerSG(nn.Module):
    ...
    def get_mean_graph_feat(self, scene_graph_feat_list):
        sg_feat = []
        for feat in scene_graph_feat_list:
    ...
    def forward(self, imgs, scene_graph):
        ...
        sg_feat_q4 = self.get_mean_graph_feat(sg_feat_q4_list)
        sg_feat_q3 = self.get_mean_graph_feat(sg_feat_q3_list)
        sg_feat_q2 = self.get_mean_graph_feat(sg_feat_q2_list)
        sg_feat_q1 = self.get_mean_graph_feat(sg_feat_q1_list)
